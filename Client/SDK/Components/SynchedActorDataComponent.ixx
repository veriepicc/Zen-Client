...
export module SynchedActorDataComponent;

export enum class ActorDataIDs : unsigned char 
{
    Reserved0 = 0,
...
export enum class DataItemType : unsigned char 
{
    Byte = 0,
    Short = 1,
    Int = 2,
...
export class SynchedActorData 
{
public:
    std::vector<DataItem*> itemsArray;
    std::bitset<136> dirtyFlags;
    std::bitset<136> hasComponentData;
};

export struct SynchedActorDataComponent 
{
